...
The project is using building the Calculator’s business logic in Swift using the MVVM model with the best practices in mind.
...
- Calculator - styles, constans.
- View - configuration views files
- Models - model objects
- Components - contains app modules (UI + Code)
...
Project Link: [CalculatorApp]([https://github.com/your_username/repo_name](https://github.com/AlexeyEkimow/Calculator)
